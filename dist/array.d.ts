...
declare const uri = "ArraySchema";
declare const errorCode = "E_ARRAY_SCHEMA";
...
export declare const ArraySchema: <ItemSchema extends Schema<any, any, any, any>>(itemSchema: ItemSchema) => ArraySchema<ItemSchema>;
export {};
