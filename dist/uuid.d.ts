...
export declare const UuidSchema: import("./utils").Schema<"UuidSchema", unknown, Uuid, import("./utils").SchemaError<"E_STRING", unknown> | import("./utils").SchemaError<"E_UUID", unknown>>;
export {};
