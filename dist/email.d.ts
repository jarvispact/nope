...
export declare const EmailSchema: import("./utils").Schema<"EmailSchema", unknown, Email, import("./utils").SchemaError<"E_STRING", unknown> | import("./utils").SchemaError<"E_EMAIL", unknown>>;
export {};
